# This file is managed by the 'files-matatika-lab' file bundle and updated automatically when `meltano upgrade` is run.
...
#     meltano config --plugin-type=files files-matatika-lab set _update orchestrate/matatika/elastic-search/config/setup.sh false
